...
namespace Engine
{
	namespace Graphics
	{
		...
		IDeviceFactory * CreateDeviceFactory(void) { return CreateSystemDeviceFactory(); }
		IDevice * GetCommonDevice(void) { return GetSystemCommonDevice(); }
		void ResetCommonDevice(void) { ResetSystemCommonDevice(); }
