...
namespace Engine
{
	namespace MacOSXSpecific
	{
		...
		TouchBar::TouchBar(void) : RootItems(0x10), Links(0x20), Callback(0), MainItemID(0), WindowAttached(0)
		{
		...
		TouchBar * TouchBar::GetTouchBarFromWindow(Windows::IWindow * window)
		{
			return static_cast<TouchBar *>(Cocoa::GetWindowTouchBar(window));
		}
