...
namespace Engine
{
	namespace UI
	{
		...
		public:
			...
			virtual void Render(IRenderingDevice * device, const Box & at);
		...
		public:
			...
			public:
				...
				virtual void SetCursor(Windows::IWindow * window, UI::Point at) override;
				virtual void MouseMove(Windows::IWindow * window, UI::Point at) override;
				virtual void LeftButtonDown(Windows::IWindow * window, UI::Point at) override;
				virtual void LeftButtonUp(Windows::IWindow * window, UI::Point at) override;
				virtual void LeftButtonDoubleClick(Windows::IWindow * window, UI::Point at) override;
				virtual void RightButtonDown(Windows::IWindow * window, UI::Point at) override;
				virtual void RightButtonUp(Windows::IWindow * window, UI::Point at) override;
				virtual void RightButtonDoubleClick(Windows::IWindow * window, UI::Point at) override;
		...
		private:
			...
			Dictionary::Dictionary<int, Control> _timers;
			Dictionary::Dictionary<Windows::SystemCursorClass, Windows::ICursor> _cursors;
		...
		public:
			...
			void Invalidate(void);
			void Render(IRenderingDevice * device);
