...
namespace Engine
{
	namespace UI
	{
		namespace Controls
		{
			...
			void ListBox::Render(IRenderingDevice * device, const Box & at)
			{
				Shape ** back = 0;
			...
			void TreeView::Render(IRenderingDevice * device, const Box & at)
			{
				Shape ** back = 0;
				Template::Shape * temp = 0;
				if (Disabled) {
			...
			void ListView::Render(IRenderingDevice * device, const Box & at)
			{
				Shape ** back = 0;
				Template::Shape * temp = 0;
				Shape ** header = 0;
