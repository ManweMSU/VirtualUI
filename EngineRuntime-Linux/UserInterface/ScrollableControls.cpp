...
namespace Engine
{
	namespace UI
	{
		namespace Controls
		{
			...
			void VerticalScrollBar::Render(IRenderingDevice * device, const Box & at)
			{
			...
			void HorizontalScrollBar::Render(IRenderingDevice * device, const Box & at)
			{
			...
			void VerticalTrackBar::Render(IRenderingDevice * device, const Box & at)
			{
			...
			void HorizontalTrackBar::Render(IRenderingDevice * device, const Box & at)
			{
				Box tracker_pos = GetTrackerPosition(at);
				Shape * tracker = 0;
				Shape * bar = 0;
