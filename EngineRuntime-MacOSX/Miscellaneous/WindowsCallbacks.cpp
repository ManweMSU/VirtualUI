...
namespace Engine
{
	namespace Windows
	{
		...
		void IWindowCallback::SetCursor(IWindow * window, Point at) { GetWindowSystem()->SetCursor(GetWindowSystem()->GetSystemCursor(SystemCursorClass::Arrow)); }
		void IWindowCallback::MouseMove(IWindow * window, Point at) {}
		void IWindowCallback::LeftButtonDown(IWindow * window, Point at) {}
		void IWindowCallback::LeftButtonUp(IWindow * window, Point at) {}
		void IWindowCallback::LeftButtonDoubleClick(IWindow * window, Point at) {}
		void IWindowCallback::RightButtonDown(IWindow * window, Point at) {}
		void IWindowCallback::RightButtonUp(IWindow * window, Point at) {}
		void IWindowCallback::RightButtonDoubleClick(IWindow * window, Point at) {}
