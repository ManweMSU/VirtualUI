...
namespace Engine
{
	namespace MacOSXSpecific
	{
		...
		public:
			...
			virtual Graphics::IBitmap * GetImage(void) = 0;
			virtual void SetImage(Graphics::IBitmap * image) = 0;
			virtual int GetMainItemID(void) = 0;
			virtual void SetMainItemID(int ID) = 0;
		};
		...
		public:
			...
			virtual Graphics::IBitmap * GetMinimalImage(void) = 0;
			virtual void SetMinimalImage(Graphics::IBitmap * image) = 0;
			virtual Graphics::IBitmap * GetMaximalImage(void) = 0;
			virtual void SetMaximalImage(Graphics::IBitmap * image) = 0;
		};
		class TouchBar : public Object
		{
			...
			void * Bar;
			void * Delegate;
			UI::IEventCallback * Callback;
			Windows::IWindow * WindowAttached;
			ObjectArray<TouchBarItem> RootItems;
			Volumes::ObjectDictionary<string, TouchBarItem> Links;
			int MainItemID;
		...
		public:
			...
			UI::IEventCallback * GetCallback(void);
			void SetCallback(UI::IEventCallback * callback);
			void * GetDelegate(void);
			Windows::IWindow * GetCurrentWindow(void);
			...
			static void SetTouchBarForWindow(Windows::IWindow * window, TouchBar * bar);
			static TouchBar * GetTouchBarFromWindow(Windows::IWindow * window);
		};
