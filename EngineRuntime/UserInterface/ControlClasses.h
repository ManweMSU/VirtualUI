		...
		namespace Template
		{
			namespace Controls
			{
				...
				ENGINE_CONTROL_DERIVATIVE_CLASS(ListBox, VerticallyScrollable)
					...
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewNormal)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewFocused)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewElementAlternateBackground)
				...
				ENGINE_CONTROL_CLASS(MenuBar)
					...
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewElementNormal)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewElementHot)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewElementPressed)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewElementDisabled)
					ENGINE_DEFINE_REFLECTED_PROPERTY(INTEGER, SizeLeftSpace)
					ENGINE_DEFINE_REFLECTED_PROPERTY(INTEGER, SizeMenuBorder)
					ENGINE_DEFINE_REFLECTED_PROPERTY(INTEGER, SizeMenuItem)
					ENGINE_DEFINE_REFLECTED_PROPERTY(INTEGER, SizeMenuSeparator)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewClientEffect)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewMenuShadow)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewMenuFrame)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewMenuArrow)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewMenuSeparator)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewMenuItemNormal)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewMenuItemGrayed)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewMenuItemHot)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewMenuItemNormalChecked)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewMenuItemGrayedChecked)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, ViewMenuItemHotChecked)
				ENGINE_END_REFLECTED_CLASS

				ENGINE_CONTROL_CLASS(MenuBarElement)
					ENGINE_DEFINE_REFLECTED_PROPERTY(INTEGER, ID)
					ENGINE_DEFINE_REFLECTED_PROPERTY(BOOLEAN, Disabled)
					ENGINE_DEFINE_REFLECTED_PROPERTY(BOOLEAN, FlushRight)
					ENGINE_DEFINE_REFLECTED_PROPERTY(STRING, Text)
					ENGINE_DEFINE_REFLECTED_PROPERTY(DIALOG, Menu)
				ENGINE_END_REFLECTED_CLASS
