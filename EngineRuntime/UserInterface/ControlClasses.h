	...
	namespace UI
	{
		namespace Template
		{
			namespace Controls
			{
				...
				ENGINE_CONTROL_CLASS(VirtualStation)
					ENGINE_DEFINE_REFLECTED_PROPERTY(INTEGER, ID)
					ENGINE_DEFINE_REFLECTED_PROPERTY(BOOLEAN, Invisible)
					ENGINE_DEFINE_REFLECTED_PROPERTY(BOOLEAN, Disabled)
					ENGINE_DEFINE_REFLECTED_PROPERTY(BOOLEAN, Autosize)
					ENGINE_DEFINE_REFLECTED_PROPERTY(BOOLEAN, Render)
				...
				ENGINE_END_REFLECTED_CLASS
				ENGINE_CONTROL_CLASS(VirtualStationData)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, WindowActiveView)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, WindowInactiveView)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, WindowSmallActiveView)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, WindowSmallInactiveView)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, WindowDefaultBackground)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, MenuShadow)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, MenuBackground)
					ENGINE_DEFINE_REFLECTED_PROPERTY(APPLICATION, MenuArrow)
					ENGINE_DEFINE_REFLECTED_PROPERTY(DIALOG, WindowCloseButton)
					ENGINE_DEFINE_REFLECTED_PROPERTY(DIALOG, WindowMaximizeButton)
					ENGINE_DEFINE_REFLECTED_PROPERTY(DIALOG, WindowMinimizeButton)
					ENGINE_DEFINE_REFLECTED_PROPERTY(DIALOG, WindowHelpButton)
					ENGINE_DEFINE_REFLECTED_PROPERTY(DIALOG, WindowSmallCloseButton)
					ENGINE_DEFINE_REFLECTED_PROPERTY(DIALOG, WindowSmallMaximizeButton)
					ENGINE_DEFINE_REFLECTED_PROPERTY(DIALOG, WindowSmallMinimizeButton)
					ENGINE_DEFINE_REFLECTED_PROPERTY(DIALOG, WindowSmallHelpButton)
					ENGINE_DEFINE_REFLECTED_PROPERTY(INTEGER, WindowFixedBorder)
					ENGINE_DEFINE_REFLECTED_PROPERTY(INTEGER, WindowSizableBorder)
					ENGINE_DEFINE_REFLECTED_PROPERTY(INTEGER, WindowCaptionHeight)
					ENGINE_DEFINE_REFLECTED_PROPERTY(INTEGER, WindowSmallCaptionHeight)
					ENGINE_DEFINE_REFLECTED_PROPERTY(INTEGER, MenuBorder)
					ENGINE_DEFINE_REFLECTED_PROPERTY(INTEGER, CaretWidth)
				ENGINE_END_REFLECTED_CLASS
